...
class HomeController extends Controller{
	 ...
	 *
	 * @Route("/user/{id}/znajomi",name="path_user_friends")
	 */
	 
	public function friendsAction(DBService $db_service,CookieService $cookie_service,$id=null){
		...
		$db_service -> getFriends($userData -> getId());
		...
		return $this->render('Profile/home.html.twig',array('userData' => $userData,'myData' => $myData,'photoCount' => $photoCount));
	}
